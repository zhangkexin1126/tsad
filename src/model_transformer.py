...
#             save: [sequence length, batch size, embed dim]
#         """
#         print(x.shape)
#         print(self.pe.shape)
...
class TransformerLayerNormEncoderLayer(nn.modules.Module):
    ...
    Args:
        ...
        batch_first: If ``True``, then the input and save tensors are provided
...
class Transformer_Encoder(nn.Module):
    ...
    def forward(self, x, key_padding_masks=None, src_masks=None):
        ...
        # out = self.act(out)  # the save transformer encoder/decoder embeddings don't include non-linearity
